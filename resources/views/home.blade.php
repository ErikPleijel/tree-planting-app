            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300 p-6">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <h3 class="text-xl font-bold mb-2">Become a Grower</h3>
                        <p class="text-gray-600 mb-4">Join our community of tree planters and help grow the future.
                            Every tree counts!</p>
                        @guest
                            <div class="mt-4 hidden">
                                <a href="{{ route('register') }}" class="bg-primary text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors">Join as Planter</a>
                            </div>
                        @endguest
                ...
                <div class="bg-white rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300 p-6">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <p class="text-gray-600 mb-4">Share our mission with your community and help us grow our
                            impact.</p>
                        <p class="text-xl font-bold mt-4 mb-2">ItacenMu.org</p>
                        <div class="flex flex-col items-center gap-2">
                            <button onclick="copyLink()" class="bg-primary text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors flex items-center gap-2">
                            ...
                            <div id="copyNotification" class="hidden">
                                <span class="text-green-600 text-sm">Link copied!</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-col md:flex-row gap-6 justify-center mb-8">
                ...
                <div class="bg-white rounded-lg shadow-xl flex-1 p-6">
                    <div>
                        ...
                        <p class="mb-6 text-gray-600">Access comprehensive data about our tree planting progress,
                            species distribution, and regional achievements.</p>
                        <div class="flex justify-center">
                            <a href="{{ route('stats.stats1') }}" class="bg-primary text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                     stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
