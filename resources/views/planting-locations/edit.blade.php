    ...
    <div class="max-w-2xl mx-auto mt-10 p-6 bg-white shadow-md rounded-lg">
        ...
        <form method="POST" action="{{ route('planting-locations.update', $plantingLocation) }}" class="space-y-4">
            ...
            <div class="flex justify-end space-x-2 pt-4">
                ...
                <a href="{{ route('planting-locations.show', $plantingLocation) }}" class="border border-gray-300 text-gray-700 px-6 py-3 rounded hover:bg-gray-50 transition-colors">Cancel</a>
            </div>
        </form>
    </div>
